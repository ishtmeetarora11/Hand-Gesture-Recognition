...
firebase1 = firebase.FirebaseApplication("https://virtual-navigator-9324d-default-rtdb.firebaseio.com/", None)
...
def write_on_image(frame):
    ...
    #print(text)
    firebase1.put('/UmJMul34a0OXM6g3SnjGkRfdUQF3','Nearby place',text)
